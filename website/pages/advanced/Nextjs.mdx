...
> 💡 This guide shows how to use the library with Next.js /app router (/pages router is also supported). @watercubz/dockly **+v1.0.0** supports Next.js 15 with React 18.
